...
@pytest.mark.parametrize("inputs, expected_output", [
    ({'s1': 144.0360, 's2': 29.2360, 's3': 46.0110, 'alpha': 113.1556, 'beta': 16.1858, 'gamma': 103.5780, 'azim': -73.7462, 'inc': -39.1889, 'theta': 175.3328, 'deltaP': 19.8546, 'Pp': 11.2787, 'nu': 0.2627}, (-20.3820, -45.2208, -21.3581, -8.0949, -57.5078, -60.0887, [-1.7980, 91.9749, 88.1922, 89.7175, 178.0050, 9.9449])),
