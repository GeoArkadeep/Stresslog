...
class MyApp(toga.App):
    ...
    def run_custom_ucs(self):
        ...
        self.custom_edit( 
            ...
            unitdict,["Metres","MPa"],[float,float]
        )
        #print(UCSs)
    ...
    def run_custom_forms(self):
        ...
        self.custom_edit( 
            ...
            formunitdict,["Metres","","","","Metres","Metres","","Metres","Metres","","","","","","","","","",""],[float,int,str,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float]
        )
        #print(forms)
...
"""
    ...
    def custom_edit(self, csv_path, headers, unittypes, unitdict, target_units, datatypes):
        ...
        self.editor_window = toga.Window(title='Data Editor')
    ...
    def open_column_mapping_window(self):
        self.mapping_window = toga.Window(title="Map Columns")
        self.create_mapping_content()
        self.mapping_window.show()

    def create_mapping_content(self):
        main_box = toga.Box(style=Pack(direction=COLUMN, padding=10))
        self.mapping = {}
        current_headers = ["None"] + list(self.df.columns)
        ...
        for expected_header in self.expected_headers:
            ...
            dropdown = toga.Selection(items=current_headers, style=Pack(flex=1))
            row.add(label)
            row.add(dropdown)
            main_box.add(row)
        ...
        self.mapping_window.content = main_box
    ...
    def finalize_dataframe(self):
        ...
        self.create_editor_content()

    def create_editor_content(self):
        ...
        for header in self.expected_headers:
            ...
            header_label = toga.Label(header, style=Pack(width=column_width-4, text_align='center', padding=5))
        ...
        self.editor_window.content = main_box
